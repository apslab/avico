...
class MovementsControllerTest < ActionController::TestCase
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post :create, movement: { company_id: @movement.company_id, period: @movement.period, quantity: @movement.quantity, variety_id: @movement.variety_id }
    end
  ...
  test "should update movement" do
    put :update, id: @movement, movement: { company_id: @movement.company_id, period: @movement.period, quantity: @movement.quantity, variety_id: @movement.variety_id }
    assert_redirected_to movement_path(assigns(:movement))
  end
